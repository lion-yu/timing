...
public class HttpUtils {
     ...
     */
    public static String getRequest(String path) throws Exception, URISyntaxException, IOException {
        ...
        try {
            ...
            throw new ClientProtocolException("postRequest -- Client protocol exception!", e);
        }
        catch (IOException e) {
            throw new IOException("postRequest -- IO error!", e);
        }
        finally {
